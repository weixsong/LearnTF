...
def main(unused_argv):
    ...
    with tf.device(
        ...
        if FLAGS.sync_replicas:
            ...
            # Initial token and chief queue runners required by the
            # sync_replicas mode
        ...
        # while the remaining workers will wait for the preparation to
        # complete.
        if is_chief:
        ...
        if FLAGS.sync_replicas and is_chief:
            # Chief worker will start the chief queue runner and call the init
            # op.
