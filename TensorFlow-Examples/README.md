...
**This repo is forked from [TensorFlow-Examples](https://github.com/aymericdamien/TensorFlow-Examples), I just want to keep myself track of my changes, experiments, Thanks for the author's contribution.**
